tell application "Skim"
	...
	set docTextInfo to "Lines in document: " & docParas & return & ¬
		"Words in document: " & docWords & return & ¬
	...
	if length of selText is 0 then
		...
		set selTextInfo to "Lines in selection: " & selParas & return & ¬
			"Words in selection: " & selWords & return & ¬
